...
export const env = {
  ...
  // App Information
  APP_NAME: import.meta.env.VITE_APP_NAME || "Colgate-Palmolive",
  ...
  // Contact Information
  SUPPORT_EMAIL:
    import.meta.env.VITE_SUPPORT_EMAIL || "support@sahamtradingplc.com",
  TELEGRAM_CHANNEL:
    import.meta.env.VITE_TELEGRAM_CHANNEL ||
    "https://t.me/sahamtradingofficial",
  COMPANY_PHONE: import.meta.env.VITE_COMPANY_PHONE || "+251900280080",
  COMPANY_ADDRESS:
    import.meta.env.VITE_COMPANY_ADDRESS || "Addis Ababa, Ethiopia",
